...
export default function BulandManifestoSection() {
        ...
        >
          ...
          <motion.div className="md:col-span-4 lg:col-span-3" variants={itemVariants}>
            <div className="sticky top-20">
              ...
              <Button className="bg-transparent hover:bg-red-600 text-red-600 hover:text-white border border-red-600 rounded-none px-6 py-2 transition-colors duration-300">
                ...
                >
                  ...
                  <AnimatePresence mode="wait">
                    {activeIndex === index && (
                      ...
                      >
                        <p className="mt-4 text-zinc-400 max-w-3xl">{point.description}</p>
                      </motion.div>
                    )}
                  </AnimatePresence>
                </motion.div>
